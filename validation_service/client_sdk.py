...
class ValidationClient:
    ...
    def validate_project_file(
        ...
        with open(file_path, 'rb') as f:
            ...
            response = self.session.post(
                f"{self.base_url}/validate/upload",
                files=files,
                data=data
            )
            response.raise_for_status()
    ...
    def validate_project_folder(
        ...
        response = self.session.post(
            f"{self.base_url}/validate/folder",
            json=data
        )
        response.raise_for_status()
        result = response.json()
    ...
    def download_report(self, validation_id: str, output_path: Optional[Union[str, Path]] = None) -> Path:
    ...
    def _is_text_file(self, filename: str) -> bool:
        ...
        text_extensions = {
            '.py', '.js', '.jsx', '.ts', '.tsx', '.java', '.cs', '.php', '.rb', '.go', '.rs',
        ...
        return ext in text_extensions or 'makefile' in filename.lower() or 'dockerfile' in filename.lower()
