...
"""
        ...
        self.assertGreaterEqual(security_score, 90, f"Security score {security_score} should be >= 90")
        self.assertGreaterEqual(quality_score, 90, f"Quality score {quality_score} should be >= 90")
        self.assertGreaterEqual(architecture_score, 80, f"Architecture score {architecture_score} should be >= 80")
