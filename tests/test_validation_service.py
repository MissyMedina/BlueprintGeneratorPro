...
class TestValidationClient(unittest.TestCase):
    ...
    def test_is_text_file(self):
        ...
        # Test text files
        text_files = [
            'main.py', 'app.js', 'style.css', 'index.html',
            'README.md', 'config.json', 'docker-compose.yml',
        ...
        binary_files = [
            ...
            'binary.exe', 'library.so', 'font.ttf'
        ]
    ...
    def test_validate_folder_contents(self, mock_post):
        ...
        with patch.object(self.client, '_read_folder_contents', return_value=folder_contents):
            with patch.object(self.client, '_wait_for_completion') as mock_wait:
                mock_wait.return_value = {"validation_id": "test-123", "status": "completed"}
...
class TestValidationServiceHelpers(unittest.TestCase):
    ...
    def test_convenience_functions(self):
        ...
        try:
            from client_sdk import validate_project, validate_git_repo
    ...
    def test_validation_profiles(self):
        ...
        profiles = ["comprehensive", "security-focused", "quality-focused", "architecture-focused"]
