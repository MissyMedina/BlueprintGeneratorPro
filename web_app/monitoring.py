    ...
    def record_system_metrics(self):
        ...
        try:
            ...
            self.metrics["cpu_usage"].append(
                {"timestamp": datetime.now().isoformat(), "percent": cpu_percent}
            )
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "performance": {
                ...
                "requests_per_minute": (
                    round(total_requests / (uptime / 60), 2) if uptime > 0 else 0
                ),
            },
            "system": {
...
class HealthChecker:
    ...
    def check_dependencies() -> Dict[str, Any]:
        ...
        dependencies = {"status": "healthy", "checks": {}}

        # Check if required modules can be imported
        required_modules = ["fastapi", "uvicorn", "pydantic", "requests", "psutil"]
...
class StructuredLogger:
    ...
    def log_document_generation(
        self, doc_type: str, project_name: str, success: bool, generation_time: float
    ):
