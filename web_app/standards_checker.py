...
class StandardsChecker:
    ...
    def generate_compliance_checklist(self, standards: Dict[str, StandardCheck], scope: str = "security") -> List[Dict[str, str]]:
    ...
    def format_standards_report(self, standards: Dict[str, StandardCheck]) -> str:
        ...
        for name, standard in standards.items():
            status_emoji = "✅" if standard.status == "current" else "⚠️" if standard.status == "outdated" else "❓"
